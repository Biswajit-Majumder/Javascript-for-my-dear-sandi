...
// it only slices the forward and backward spaces not any in between spaces

let sandi =  " Sandi vai amader nijer vaipo    n       ggs     "

console.log("The main this is this characters",sandi.length,"long");

let newThing = sandi.trim()

console.log(newThing)

console.log("Trimmed",sandi.trim().length)
